              ...
              <div class="user-avatar-section">
                <div class="d-flex justify-content-start">
                  ...
                  $url1='storage/coreImages/user.png';
                   ...
                   ?>
                  <img class="img-fluid rounded" src="{{asset($url1)}}" height="104" width="104" alt="User avatar" />
          ...
          <table class="table">
            ...
            <tr>
              ...
              @for ($i = $start; $i <= $end; $i++) <td>
                ...
                <?php }else if($tmp==-1){ ?>
                <div class="text-center bg-success bg-lighten-4 shadow div-ku shadow" style="width: 20px;height:20px">
                  {{ $get_data->{"strokes_hole_$i"} }}
                </div>
                <?php }else if($tmp<-1){ ?>
                <div class="text-center bg-warning bg-lighten-4 shadow div-ku shadow" style="width: 20px;height:20px">
                  {{ $get_data->{"strokes_hole_$i"} }}
                </div>
                <?php }else if($tmp==0){ ?>
                {{ $get_data->{"strokes_hole_$i"} }}
                <?php }else if($tmp==1){ ?>
                <div class="text-center bg-danger bg-lighten-4 shadow div-ku shadow" style="width: 20px;height:20px">
                  {{ $get_data->{"strokes_hole_$i"} }}
                </div>
                <?php }else if($tmp>1){ ?>
                <div class="text-center bg-info bg-lighten-4 shadow div-ku shadow" style="width: 20px;height:20px">
                  {{ $get_data->{"strokes_hole_$i"} }}
                </div>
                <?php } ?>
                </td>
