...
<nav
  ...
  <nav
    ...
    <?php
        ...
        @$user = Auth::user(); 
        @$words = explode(" ", ucwords($user->name));
        $acronym = "";
        foreach ($words as $w) {
         $acronym .= @$w[0];
        }
    ...
    <li class="nav-item dropdown dropdown-user">
      <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);"
        ...
        <div class="user-nav d-sm-flex d-none">
          ...
          <span class="user-status">{{ @ucwords($user->user_type)}}</span>
        </div>
      ...
      <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user">
        <a class="dropdown-item" href="<?php if($isadmin==true){ echo "#"; }else{ echo "/user/profile" ; } ?>">
          <i class="mr-50" data-feather="user"></i> Profile
        </a>
        <a class="dropdown-item" href="<?php if($isadmin==true){ echo route('admin-logout'); }else{ echo route('user-logout1') ; } ?>">
