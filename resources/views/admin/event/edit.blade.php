    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" id="formKu" autocomplete="off" action="/admin/event/{{$data->event_code}}"
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input id="event_name" class="form-control" value="{{$data->event_name}}"
                                        name="event_name" type="text" placeholder="Insert Event Name" required />
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                    <label for="event_type">Event Type</label>
                                    <select id="event_type" name="event_type" onchange="change_event()"
                                        class="form-control" required>
                                        <option value="">Select Event Type</option>
                                        <option <?php if($data->event_type=='tournament'){ echo "selected";} ?>
                                            value="tournament">Tournament</option>
                                        <option <?php if($data->event_type=='gameday'){ echo "selected";} ?>
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                    ...
                                    <select id="teeing_ground" name="teeing_ground" class="form-control" required>
                                        ...
                                        <option <?php if($data->teeing_ground=='black'){ echo "selected";} ?>
                                            value="black">Black</option>
                                        <option <?php if($data->teeing_ground=='blue'){ echo "selected";} ?>
                                            value="blue">Blue</option>
                                        <option <?php if($data->teeing_ground=='white'){ echo "selected";} ?>
                                            value="white">White</option>
                                        <option <?php if($data->teeing_ground=='red'){ echo "selected";} ?> value="red">
                                            Red</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input id="max_player" value="{{$data->max_player}}" class="form-control"
                                        name="max_player" type="number" placeholder="Insert Max Player" required />
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                    <label for="fp-date-time">Kick Off Time</label>
                                    <input type="text" value="{{$data->kick_off}}" id="fp-date-time" name="kick_off"
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{$data->deadline_register}}" id="fp-date-time2" required
                                        name="deadline_register" class="form-control flatpickr-date-time"
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                    ...
                                    <select id="field" name="field_id" required class="form-control">
                                        ...
                                        <option <?php if($data->field_id==$item->id){ echo "selected";} ?>
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="custom-control custom-switch custom-switch custom-switch-success">
                                    ...
                                    <input type="checkbox" onchange="change_calculate()" name="calculate_ld"
                                        class="custom-control-input" id="calculate_ld"
                                        <?php if($data->calculate_ld==1){ echo "checked";} ?> />
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                    ...
                                    <select id="hole_type" onchange="check_hole()" name="hole_type" class="form-control"
                                        ...
                                        <option <?php if($data->hole_type=='19'){ echo "selected";} ?> value="19">1 - 9
                                            Hole</option>
                                        <option <?php if($data->hole_type=='1018'){ echo "selected";} ?> value="1018">10
                                            - 18 Hole</option>
                                        <option <?php if($data->hole_type=='18'){ echo "selected";} ?> value="18">18
                                            Hole</option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 text-center">
                                ...
                                <img class="img-fluid rounded" id="img-upload" alt="No poster Image"
                                    src="{{asset("storage/masterImages/".$data->poster) }}" width="100%" /><br><br>
                            </div>
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="short_description" name="short_description" class="form-control"
                                        required
                                        placeholder="Type event short decription for front view purpose..." />{{$data->short_description}}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
...
<section id="input-file-browser">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Set Event Configuration</h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-6">
                            <div class="form-group">
                                ...
                                <input id="avg_drive" class="form-control drive_cal" value="{{$data->avg_drive}}"
                                    name="avg_drive" type="number" step=".01" placeholder="Insert Average Drive"  />
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-6">
                            <div class="form-group">
                                <label for="long_drive">Long Drive</label>
                                <input id="long_drive" class="form-control drive_cal" value="{{$data->long_drive}}"
                                    name="long_drive" type="number" step=".01" placeholder="Insert Long Drive"  />
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <option <?php if($data->status=='inprogress'){echo "selected" ;} ?> value="inprogress">Inprogress</option>
                                <option <?php if($data->status=='closed'){echo "selected" ;} ?> value="closed">Closed</option>
                                <option <?php if($data->status=='finished'){echo "selected" ;} ?> value="finished">Finished</option>
                                </select>
                            </div>
                        </div>
                    </div>
